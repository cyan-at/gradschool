...
class Arrow1(Shape):
    ...
    def __init__(self, start, end, style='->', linestyle="solid"):
        arrow = Line(start, end)
        arrow.set_arrow(style)

        print("linestyle", linestyle)
        arrow.set_linestyle(linestyle)
        # Note:
...
class Axis(Shape):
    def __init__(self, start, length, label,
                 ...
                 label_spacing=1./10, label_alignment='left'):
        """
...
class Gravity(Axis):
    ...
    def __init__(self, start, length, fontsize=0):
        Axis.__init__(self, start, length, '$g$', below=False,
                      rotation_angle=-90, label_spacing=1./5,
                      fontsize=fontsize)
...
class Distance_wText(Shape):
    ...
    def __init__(self, start, end, text, fontsize=0, text_spacing=1/60.,
                 alignment=None, text_pos='mid', linestyle='solid'):
        start = arr2D(start)
        end   = arr2D(end)
        ...
        if text_pos == 'mid':
            ...
            text = Text_wArrow(text, text_pos, mid, alignment='left',
                               fontsize=fontsize)
        arrow = Arrow1(start, end, style='<->', linestyle=linestyle)
