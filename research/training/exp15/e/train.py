...
def get_model(
    ...
    rho0_WASS = lambda y_true, y_pred: WASS_4(y_true, y_pred, sinkhorn, rho0_tensor, C, N, dx)
    rho0_WASS.__name__ = "rho0_WASS"
    rhoT_WASS = lambda y_true, y_pred: WASS_4(y_true, y_pred, sinkhorn, rhoT_tensor, C, N, dx)
