...
if __name__ == '__main__':
    ...
    dphi_dinput_t0 = dphi_dinput[:M, :]
    dphi_dinput_tT = dphi_dinput[M:2*M, :]
    dphi_dinput_tt = dphi_dinput[2*M:, :]
    ...
    title_str += "\n"
    title_str += "N=15, d=2, sigmoid, clamped weights"
    title_str += "\n"
    ...
    plt.savefig('rhoopt_dphidx_dphidy.png', dpi=500, bbox_inches='tight')
    print("saved figure")
